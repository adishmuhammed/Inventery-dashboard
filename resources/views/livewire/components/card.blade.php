<div class="sm:flex sm:items-center sm:justify-end">
    ...
    <div
        ...
        <p class="w-full text-sm leading-tight text-gray-400 hidden sm:block">{{ $blog->shortDescribtion }}</p>
        <a href="{{ route('blog-detail') }}" class="w-full text-sm leading-tight text-green-500">Read more</a>
    </div>
</div>
